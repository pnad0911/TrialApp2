 ...
 * @see <a href='http://jcouture.net/cisc190/A19013.php'>Program Specification</a>
...
public class A19013 extends JDialog {
     ...
     * @throws Exception
     */
    private static void createDBAndTablesButton() throws Exception
    {
     ...
     * @throws Exception
     */
    private static String stringSQL(String strTable, String strFileName) throws Exception {
        INET net = new INET();
        String strPage;
     ...
     * @throws Exception
     */
    private static void popGrades() throws Exception {
     ...
     * @throws Exception
     */
    private static void popRoster() throws Exception {
     ...
     */
    private static float getQuizTotal(String strStuID) {
        DBUpdt db = new DBUpdt();
        db.openConnection(strData);
        //find stuid
     ...
     */
    private static float getAsgnTotal(String strStuID) {
        int intCou;
        int intCou1 = 0;
        float fl;
        float tt = 0000;
     ...
     * @return - letter grade
     */
    private static String getLetterGrade(float fltTotal) {
    ...
    private static void CreateReport() {
        DBUpdt db = new DBUpdt();
        db.openConnection(strData);
        db.query("SELECT roster.*, grades.* FROM " + strTableRoster + " INNER JOIN grades ON roster.stuid=grades.stuid");
...
// add your code here if necessary
     ...
     * @return - boolean
     */
    private Boolean blnChange(String strT) {
        Boolean boChange;
        //only acute when user choose
        if (strT.equals(" ")) {
            boChange = false;
    ...
    private class createDBAndTablesButton1 implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            try {
    ...
    private class populateGrades implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            try {
                popGrades();
            } catch (Exception y) {
    ...
    private class populateCombo implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            try {
                PopCombo();
            } catch (Exception y) {
    ...
    private class Comboseclect implements ActionListener {
        public void actionPerformed(ActionEvent e) {
            String selection13;
